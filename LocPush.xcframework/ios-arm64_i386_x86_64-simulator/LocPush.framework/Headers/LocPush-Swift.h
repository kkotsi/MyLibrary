...
/// A Builder class that constructs a <code>NotificationParams</code> from the given parameters.
...
/// \code
/// MainLocPush.shared.mInboxCenter.getInbox (callback: { (success: Bool, response: GetInboxResponse?) in
///    if success {
...
///
- (void)getInbox:(void (^ _Nonnull)(BOOL, GetInboxResponse * _Nullable))callback :(NSInteger)limit :(NSInteger)offset :(NSString * _Nullable)associatedValue;
...
///
- (void)readMessage:(InboxMessageResponse * _Nonnull)inboxMessage :(void (^ _Nonnull)(BOOL, InboxMessageResponse * _Nullable))callback :(NSString * _Nullable)associatedValue;
...
/// \param callback A closure that will be called when the request is completed.
///
- (void)deleteMessage:(InboxMessageResponse * _Nonnull)inboxMessage :(void (^ _Nonnull)(BOOL, InboxMessageResponse * _Nullable))callback :(NSString * _Nullable)associatedValue;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
